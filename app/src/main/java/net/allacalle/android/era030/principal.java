...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo) VALUES ('2','Glasgow,Escala de Coma','Glasgow, Escala de Coma','escala');");
//Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo) VALUES ('3','CHA2DS2-VASc,Escala de Riesgo de AVC por Fibrilación Atrial','CHA2DS2-VASc','escala');");
//Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo) VALUES ('4','Pneumonia Severity Index diagnostico inicial','PSI inicial','escala');");
                //Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo) VALUES ('5','Pneumonia Severity Index puntuacion','PSI puntuacion','escala');");
//Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo) VALUES ('6','The Thrombolysis In Myocardial Infarction (TIMI)','TIMI','escala');");
//Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo) VALUES ('7','Wells Score para Embolismo Pulmonar','Wells Score para Embolismo Pulmonar','escala');");
//Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo) VALUES ('8','Wells,Score para Trombosis Venosa Profunda','Wells, Score para Trombosis Venosa Profunda','escala');");
//Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo) VALUES ('10','Aclaramiento de creatinina, formula de Cockcroft-Gault ','Aclaramiento de creatinina','general');");
//Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo,Expresion) VALUES ('12','Agua Corporal,Deficit','Agua Corporal,Deficit','general','(Agua/100)*Peso*((Sodio/140)-1)');");
//Parámetros
...
//Cloro, Deficit
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo,Expresion) VALUES ('13','Cloro,Deficit','Cloro,Deficit','general','Peso*(Cloro_Volumen_de_Distribucion/100)*(Cloro_deseado  - Cloro_medido )');");
//Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo,Expresion) VALUES ('16','Osmolaridad','Osmolaridad','general','(2*(Sodio +Potasio))+(Glucemia/18) +(Urea/6)');");
//Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo,Expresion) VALUES ('18','Bicarbonato,Exceso','Bicarbonato,Exceso','general','Peso* (Bicarbonato_VD/100)*(Bicarbonato_medido - Bicarbonato_deseado)');");
//Parámetros
...
//Formula
                db.execSQL("INSERT INTO Formulas (IdFormula,NombreCompleto,Abreviatura,Tipo,Expresion) VALUES ('21','Tension Inspirada de Oxígeno','Tension Inspirada de Oxígeno','general','Fraccion_inspirada_de_oxigeno*(Presion_barometrica - Vapor_de_agua)');");
//Parámetros
...
//Criterios de puntuación
                ...
                //Para cada formula insertaremos en la base de datos la formula, sus parametros y sus criterios de puntuacion.



                //Una vez creadas todas las tablas necesarias debe irse a la pantalla de Bienvenida para indicar al usuario
            ...
            //Mostramos  lo que queramos mostrar de la pantalla de bienvenida.

            //Debemos cargar la siguiente pantalla


            //Hasta que  funcione cargara directamente a la pantalla de Encuesta para probar las funcionalidades directamente


            //Se crea el boton ir a encuesta
         Button boton = new Button(this);
        lm.addView(boton);
        TextView textoVacia = new TextView(this);
        String cadena = "";
        cadena = cadena + bdVacia;
        textoVacia.setText(cadena);
        lm.addView(textoVacia);
        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    //Intent intent =new Intent(principal.this, Encuesta.class);
        ...
        //Al pulsar el boton nos lleva a la pantalla Encuesta
...
//Esta es la primera pantalla que se carga al iniciar la aplicación


//Al entrar si es la primera vez que se ejecuta, nos llevara a bienvenida.


//Si ya existen la BBDD en la app entonces nos lleva a inicio


//Se deberia interntar poner alguna animación mientras se va creando la BBDD por primera vez para evitar
//esa molesta y fea pantalla en blanco.