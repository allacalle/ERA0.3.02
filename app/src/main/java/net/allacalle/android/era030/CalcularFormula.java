...
public class CalcularFormula extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        final TextView textoPrueba = new TextView(this);
        textoPrueba.setText(cadenaPrueba);
        lm.addView(textoPrueba);
       ...
       final AlertDialog alertDialog = new AlertDialog.Builder(this).create();
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int iRadio = 0;
                String aux = "";
                String cadenaResultados = formulaActual.getIdFormula() + ";";
                cadenaPrueba = "";
                ...
                //Vamos a mostrar lo que ha sucedido al pulsar el boton.

                //Recorremos el vector y mostramos los resultados.

                //Si todos los campos son correctos pasamos el vector resultado a un String para pasar los datos introducidos
                // con un bundle a la siguiente actividad.
                if (camposCorrectos) {

                    for (int i = 0; i < formulaActual.contarParametros(); i++) {
                        //Vamos a meter todos los elementos del vector Resultados en una cadena de texto
                        //En el primer valor ira el Id de la formula, en los siguientes separados por ; iran los valores de los campos
                        cadenaResultados = cadenaResultados + vectorResultados[i] + ";";

                        //cadenaPrueba = cadenaPrueba + "valor elemento " + i + ":" + vectorResultados[i] + "\n";
                        cadenaPrueba = cadenaPrueba + vectorResultados[i];
                    }

                    textoPrueba.setText(cadenaPrueba);

                    //Esta cadena se pasara a la siguiente actividad.
                    ...
                    Intent intent =
                            new Intent(CalcularFormula.this, ResultadosFormula.class);

                    Bundle b = new Bundle();
                    b.putString("Resultado", cadenaResultados);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "CalcularFormula Page", // TODO: Define a title for the content shown.
                // TODO: If you have web page content that matches this app activity's content,
                // make sure this auto-generated web page URL is correct.
                // Otherwise, set the URL to null.
                Uri.parse("http://host/path"),
                // TODO: Make sure this auto-generated app deep link URI is correct.
                Uri.parse("android-app://net.allacalle.android.era030/http/host/path")
        );
